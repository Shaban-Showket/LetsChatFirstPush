...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    // for updating user active according to lifecycle
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      // for hiding the keyboard on tap on screen
            ...
            appBar: AppBar(
              ...
              title: _isSearching
                  ? TextField(
                      ...
                      // when text changes then update the searchList
                      onChanged: (val) {
                        searchList.clear();
                        for (var i in list) {
                          if (i.name
                ...
                switch (snapshot.connectionState) {
                  ...
                  case ConnectionState.done:
                    return StreamBuilder(
                      ...
                      builder: (context, snapshot) {
                        // using switchh case to check whether data have loaded or not
                        switch (snapshot.connectionState) {
                          // if data is loading
                          case ConnectionState.waiting:
                          case ConnectionState.none:
